...
pub fn narisi_ozadje(stanje: &IgralnoStanje, dead: bool) {
    ...
    draw_rectangle(0.0, tla_y, sirina, 150.0, temna_magenta);
    draw_line(0.0, tla_y, sirina, tla_y, 4.0, WHITE); // Svetleč zgornji rob tal

    // 3. Strop
    draw_rectangle(0.0, 0.0, sirina, strop_y, temna_magenta);
    draw_line(0.0, strop_y, sirina, strop_y, 4.0, WHITE);

    // 4. Dodatni dekorativni gradientni sijaj na začetni strani
